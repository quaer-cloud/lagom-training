package cloud.quaer.accountservice.api
...
object AccountserviceService  {
  val TOPIC_NAME = "greetings"
}

/**
  * The account-service service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the AccountserviceService.
  */
trait AccountserviceService extends Service {
  ...
  override final def descriptor: Descriptor = {
    ...
    named("account-service")
      ...
      .withTopics(
        topic(AccountserviceService.TOPIC_NAME, greetingsTopic _)
